...
import { FlipWords } from '@/components/Animation/Flip';
...
const Section1 = () => {
  ...
  const words = [t('home.se'), 'front-end', 'hieunotorious'];
  useEffect(() => {
    setTimeout(
  ...
  return (
    <div className="px-5 flex min-h-screen flex-col justify-between h-full items-center mt-0 lg:mt-[50px] py-[100px] ">
      <div />
      <div className="flex flex-col justify-center items-center">
        ...
        <h1 className="text-white text-[50px] md:text-[120px] lg:text-[200px] uppercase flex items-center font-bold">
                  ...
                  {wordIndex === 0 && index === imageIndex && (
                    ...
                    >
                      <Image
                        ...
                        width={156}
                        height={163}
                        className="w-[50px] md:w-[120px] lg:w-[156px] h-auto ml-[15px] animate-shake"
                      />
                    </motion.div>
                  )}
                </motion.div>
      ...
      <div className="flex flex-col gap-5 z-30">
        ...
        <motion.h1
          ...
          className="text-white text-body1 text-center"
        >
          {t('home.s1Desc')}
        </motion.h1>
      </div>
